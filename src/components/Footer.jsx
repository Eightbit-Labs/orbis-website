const FOOTER_LINKS = {
  Product: [
    { label: 'Bob — Project Manager', href: '#bots' },
    { label: 'Jim — Code Reviewer', href: '#bots' },
    { label: 'Joe — DevOps Engineer', href: '#bots' },
    { label: 'Features', href: '#features' },
    { label: 'How It Works', href: '#how-it-works' },
  ],
  Company: [
    { label: 'About Eightbit Labs', href: '#' },
    { label: 'Blog', href: '#' },
    { label: 'Careers', href: '#' },
    { label: 'Contact', href: '#' },
  ],
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-14">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-5 max-w-[220px]">
              An agentic AI workforce for Discord, built by Eightbit Labs.
            </p>
            <div className="flex items-center gap-3">
              {SOCIALS.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-lg border border-white/[0.08] bg-white/[0.04] flex items-center justify-center text-gray-400 hover:text-white hover:border-[#2563eb]/50 hover:bg-[#2563eb]/10 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/[0.06]">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Eightbit Labs. All rights reserved.
          </p>
