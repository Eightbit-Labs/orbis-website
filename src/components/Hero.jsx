    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed animate-fadeInUp delay-200">
          Bob reviews pull requests, Jim edits code with GitHub App auth, Joe keeps the public bot
          surface simple, and Orbis Command coordinates the whole network through shared Hermes
          memory.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-14 animate-fadeInUp delay-400">
